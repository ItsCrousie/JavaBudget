...
public class DebitTest {
    ...
    public void testConstructorPreconditions() {
        ...
        Exception e = assertThrows(IllegalArgumentException.class, () -> new Debit("Rent#", 100.00));
        ...
        e = assertThrows(IllegalArgumentException.class, () -> new Debit("Rent", -100.00));
        ...
        e = assertThrows(IllegalArgumentException.class, () -> new Debit("Rent", 100.0212));
